package extraction;
	...
	public class Extraction2018 {
			...
			// Constante définissant le chemin vers le dossier accueillant le fichier généré par l'analyse.
			private static final String PATH_TO_RESULT = "resultats/res/";
			...
			public static void main(String[] args) throws SecurityException, ClassNotFoundException, IOException, IllegalArgumentException, IllegalAccessException {
				...
				String[] listeDesClassesInterfaces = {"com.google.common.collect.Multimap"
				...
				createFileFromList(PATH_TO_RESULT +"concrete2018.txt", dFile.getEntityList());
				...
				d4.createTable(2);
				d4.afficheTable();
				d4.ecrireTable( PATH_TO_RESULT + "formatConc2018.rcft");
				d4.ecrireTable(PATH_TO_RESULT + "formatConc2018.csv");}
		}