 ...
 * </p>
 * <ul>
 *   <li>{@link racine.maps.impl.RoadImpl#getName <em>Name</em>}</li>
 *   <li>{@link racine.maps.impl.RoadImpl#getLenght <em>Lenght</em>}</li>
 *   <li>{@link racine.maps.impl.RoadImpl#getBorder <em>Border</em>}</li>
 *   <li>{@link racine.maps.impl.RoadImpl#getMeet <em>Meet</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RoadImpl extends MinimalEObjectImpl.Container implements Road {
	...
	public void setLenght(int newLenght) {
		...
		lenght = newLenght;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapsPackage.ROAD__LENGHT, oldLenght, lenght));
	}
